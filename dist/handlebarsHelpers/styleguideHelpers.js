...
var converterOptions = { 'literalMidWordUnderscores': true };
var converter = new showdown.Converter(converterOptions);
function registerHandlebarsHelpersStyleguide(Handlebars) {
    /**
    ...
    Handlebars.registerHelper('eachletiation', function (options) {
        ...
        context.letiations.forEach(function (letiation) {
            var newContext = _.merge(context, letiation);
    ...
    Handlebars.registerHelper('requiresPseudoStateVariations', function (options) {
        var generatePseudoStates = this.properties ? this.properties.generatepseudostates : null;
    ...
    Handlebars.registerHelper('eachAlternative2PseudoVariation', function (options) {
        var pseudoClasses = ['hover', 'active', 'focused'];
        var newContext = _.cloneDeep(this);
        var buffer = '';
        if (!newContext) {
            return buffer;
    ...
    Handlebars.registerHelper('hasSizeVariations', function (options) {
        var sizeVarations = this.properties ? this.properties.sizevariations : null;
        if (sizeVarations) {
            return options.fn(this);
        }
        return options.inverse(this);
    ...
    Handlebars.registerHelper('markedMarkdown', function (options) {
        var wrapperContents = options.fn(this);
...
exports.registerHandlebarsHelpersStyleguide = registerHandlebarsHelpersStyleguide;
;
//# sourceMappingURL=styleguideHelpers.js.map